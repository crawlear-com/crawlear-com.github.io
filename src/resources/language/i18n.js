      ...
      en: {
        translation: {
          content: {
            ...
            welcomeMessage: 'is a professional and social score board for your 1/10 or 1/24 rock crawler compatible with AECAR, ISRCC, Levante 1/24, Mini Crawler Passion and ZonaRc regional Championship competitions rules.',
            welcomeMessage2: 'Oriented to scale crawler or trail users, crawlear is a geolocated route repository and searcher. Routes are geolocated and can be imported using gpx files from your prefered app or gps device.',
      ...
      es: {
        translation: {
          content: {
            ...
            welcomeMessage: 'es un tablero profesional y social de puntuación para tus eventos o competiciones de Crawler 1/10 o 1/24 compatible con las reglas de AECAR, ISRCC, Levante 1/24, Mini Crawler Passion y el Campeonato Regional del Club ZonaRc.',
            welcomeMessage2: 'Para los usuarios de scale crawler o trail, ofrece un repositorio y buscador de rutas geolocalizadas que puedes generar a través de un fichero gpx.',
